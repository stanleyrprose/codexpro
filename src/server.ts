  ...
  registerCodexTool(
    ...
    async (args) => {
      ...
      return textResult(summary.text, {
        ...
        resolved_revision: summary.resolvedRevision,
        git_branch: summary.gitBranch,
        dirty_state: summary.dirtyState,
        workspace_fingerprint: summary.workspaceFingerprint,
        workspace_fingerprint_basis: summary.workspaceFingerprintBasis,
        bash_mode: config.bashMode,
        write_mode: config.writeMode,
        tool_mode: config.toolMode
      });
